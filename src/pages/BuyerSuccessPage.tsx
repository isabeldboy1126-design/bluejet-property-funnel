    ...
    <div className="min-h-screen flex flex-col bg-surface-light text-ink-dark">
      ...
      <main className="flex-grow max-w-3xl mx-auto w-full px-4 sm:px-6 py-10 sm:py-16 text-center">
        ...
        <div className="mb-8 sm:mb-10">
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-blue-50 text-[#0052FF] flex items-center justify-center mx-auto mb-4 border border-blue-200 shrink-0">
            <CheckCircle2 className="w-6 h-6 sm:w-7 sm:h-7 text-[#0052FF]" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 text-left items-stretch">
          ...
          <Card className="p-5 sm:p-7 flex flex-col justify-between bg-surface-card border border-surface-border shadow-sm">
            <div>
              <span className="text-[11px] font-mono font-bold tracking-wider text-[#0052FF] uppercase block mb-2">
            ...
            <div className="mt-6 sm:mt-8 pt-4 border-t border-surface-border/60">
              <a
                ...
                className="inline-flex items-center justify-center w-full px-4 sm:px-5 py-3 rounded-full text-xs sm:text-sm font-bold text-white bg-[#0052FF] hover:bg-blue-700 transition-all group text-center"
              >
